...
public class Enterprise {
	...
	// Employee management for warehouse
	private HR employeemgr;

	/*
	 * use for following attributes is deprececated. private ArrayList<Employee>
	 * hr; private ArrayList<Employee> procurement; private ArrayList<Employee>
	 * rnd; private ArrayList<Employee> market;
	 * 
	 */

	
	public Enterprise() throws WarehouseException, WrongEmployeeTypeException {
	...
	public void setProductionHouse(ProductionHouse ph) {
		this.production = ph;
	}
	public ArrayList<PFHouse> getHousesInConstruction() {
		return housesInConstruction;
	}
	public void setHousesInConstruction(ArrayList<PFHouse> pfh) {
		this.housesInConstruction = pfh;
	}
